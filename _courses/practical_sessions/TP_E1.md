...
Dans cette première partie, on codera les exercices en **python.**  Afin de créer un fichier python, vous lancer l'éditeur et enregistrer votre programme au format
